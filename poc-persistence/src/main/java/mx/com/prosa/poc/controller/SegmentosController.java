...
@CrossOrigin
public class SegmentosController extends AbstractBaseController {
	...
	public ResponseEntity<Response<SegmentosTO>> editPatch(@RequestBody SegmentosTO request,
			@PathVariable(value = "id") Long id) {
		request.setIp(super.getIpAddress());
		request.setUser(super.getUser());
		request.setId(id);

		this.segmentosService.edit(request);
	...
	public ResponseEntity<Response<BaseTO>> delete(@PathVariable(value = "id") Long id) {
		...
		SegmentosTO request = new SegmentosTO();
		request.setIp(super.getIpAddress());
		request.setUser(super.getUser());
		request.setId(id);

		this.segmentosService.delete(id);
