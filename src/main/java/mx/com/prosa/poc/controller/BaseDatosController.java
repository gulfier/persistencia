...
@CrossOrigin
public class BaseDatosController extends AbstractBaseController
{
  ...
  public ResponseEntity<Response<BaseDatosTO>> save( @RequestBody BaseDatosTO request )
  {
	...
	public ResponseEntity<Response<BaseTO>> delete(@PathVariable(value = "id") Long id) {
		...
		this.baseDatosService.delete(id);
	...
	public ResponseEntity<Response<BaseDatosTO>> editPatch(@RequestBody BaseDatosTO request,
			@PathVariable(value = "id") Long id) {
		request.setIp(super.getIpAddress());
		request.setUser(super.getUser());
		request.setId(id);

		this.baseDatosService.edit(request);
